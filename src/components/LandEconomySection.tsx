    ...
    <section id="land-economy" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 flex flex-col">
          <OrnateFrame variant="gold" glow padding="p-5 sm:p-7">
            <div className="flex items-center justify-between border-b border-[#C9A85C]/30 pb-4 mb-6">
              <div className="flex items-center gap-2.5">
                <Coins className="w-5 h-5 text-[#C9A85C]" />
                <h3 className="font-royal text-sm sm:text-base uppercase tracking-widest text-[#FFF0CA] font-bold">
                  БҮС НУТГИЙН АЛБАН ЁСНЫ ҮНЭЛГЭЭ
                </h3>
              </div>
              <span className="text-[10px] font-mono text-[#C9A85C] uppercase px-2 py-0.5 rounded bg-[#142B4A]/60 border border-[#C9A85C]/30">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-[#C9A85C]/40 text-xs font-serif uppercase tracking-wider text-[#C9A85C]">
                  ...
                  {data.landValues.map((land) => (
                    ...
                    >
                      ...
                      <td className="py-3.5 px-3">
                        <div className="font-royal font-bold text-[#FFF0CA]">
                          <EditableText
                      ...
                      {/* 1 ha price */}
                      <td className="py-3.5 px-3 text-right font-mono font-bold text-[#E8C87A]">
                        <EditableText
                          ...
                          label="1 га үнэ"
                          className="font-mono font-bold text-[#E8C87A]"
                        />
                      </td>
            ...
            {/* Admin Add Button */}
            {isEditMode && (
              <div className="mt-4 pt-4 border-t border-[#C9A85C]/20 flex justify-end">
                <button
                  type="button"
                  onClick={handleAddNewLand}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-[#142B4A] hover:bg-[#1F4E79] text-[#FFF0CA] border border-[#C9A85C]/40 rounded text-xs font-royal"
                >
        ...
        <div className="lg:col-span-5 flex flex-col">
          <OrnateFrame variant="sapphire" glow padding="p-6">
            <div className="flex items-center gap-2.5 border-b border-[#C9A85C]/30 pb-4 mb-6">
              <Calculator className="w-5 h-5 text-[#C9A85C]" />
              <div>
                <h3 className="font-royal text-sm sm:text-base uppercase tracking-widest text-[#FFF0CA] font-bold">
            ...
            <div className="space-y-4 text-xs">
              ...
              {/* Region Select */}
              <div>
                <label className="block text-xs uppercase font-serif text-[#C9A85C] mb-1.5">
                  Бүс Нутаг Сонгох (Select Region):
                </label>
                <select
                  value={calcRegionId}
                  onChange={(e) => setCalcRegionId(e.target.value)}
                  className="w-full bg-[#0C1421] text-[#FFF0CA] border border-[#C9A85C]/50 rounded-md px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-[#C9A85C] font-royal"
                >
                  {data.landValues.map((land) => (
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0C1421] text-[#FFF0CA] border border-[#C9A85C]/50 rounded-md px-3 py-2 text-xs font-mono font-bold focus:outline-none focus:ring-1 focus:ring-[#C9A85C]"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex rounded-md overflow-hidden border border-[#C9A85C]/50">
                    <button
                      type="button"
              ...
              <div className="mt-6 p-4 rounded-lg bg-[#0C1421]/95 border border-[#C9A85C]/60 space-y-3 shadow-xl">
                <div>
                  <span className="text-[10px] uppercase font-serif tracking-wider text-[#C9A85C] block">
                    Нийт Газрын Үнэлгээ (Total Valuation):
                  </span>
                  <div className="text-xl sm:text-2xl font-mono font-extrabold text-[#FFF0CA] flex items-baseline gap-1.5">
                    <span>{calculateTotalValuation().toLocaleString()}</span>
                    <span className="text-xs font-serif text-[#E8C87A]">зоос (Coins)</span>
                  </div>
                </div>

                <div className="pt-2 border-t border-[#C9A85C]/20 flex items-center justify-between">
                  <span className="text-xs text-[#D9DEE5]/80 font-serif">
                    Улсын Сангийн Жилийн Татвар (Tax):
                  </span>
                  <span className="font-mono font-bold text-[#E8C87A] text-sm">
