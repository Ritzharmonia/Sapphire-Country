...
export const ExportImportModal: React.FC = () => {
  const { activeModal, closeModal, importDataFromJson, resetToDefaults, data } = useKingdom();
        ...
        <OrnateFrame variant="platinum" glow padding="p-6 sm:p-8" className="max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between border-b border-[#CBD5E1]/30 pb-4 mb-6">
            <div className="flex items-center gap-2.5">
              <FileJson className="w-5 h-5 text-[#CBD5E1]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="font-royal text-sm font-bold text-[#FFFFFF]">
                  1. Архивын Файл Татах (Export)
                </span>
                <span className="text-[10px] text-[#CBD5E1] font-mono">BACKUP</span>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 bg-[#1F4E79] hover:bg-[#2A75D3] text-[#FFFFFF] rounded font-royal border border-[#CBD5E1] shadow"
                >
                ...
                <button
                  type="button"
                  onClick={handleCopy}
                  className="flex items-center gap-1.5 px-3 py-2 bg-[#142B4A] hover:bg-[#1F4E79] text-[#FFFFFF] rounded font-royal border border-[#CBD5E1]/40"
                >
                  {copied ? <Check className="w-3.5 h-3.5 text-green-400" /> : <Copy className="w-3.5 h-3.5 text-[#CBD5E1]" />}
                  <span>{copied ? 'Хуулагдлаа!' : 'JSON Хуулах (Copy)'}</span>
                </button>
              </div>

              <div className="pt-4 border-t border-[#CBD5E1]/20">
                <button
                  type="button"
                  onClick={handleReset}
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-[#CBD5E1] font-mono">RESTORE</span>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full bg-[#0C1421] text-[#FFFFFF] border border-[#CBD5E1]/40 rounded p-2 text-[10px] font-mono focus:outline-none focus:ring-1 focus:ring-[#CBD5E1]"
                />
              </div>

              <div className="flex items-center justify-between gap-2">
                <label className="cursor-pointer px-3 py-1.5 bg-[#142B4A] hover:bg-[#1F4E79] text-[#D9DEE5] rounded border border-[#CBD5E1]/40 text-xs font-serif flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="px-4 py-1.5 bg-[#CBD5E1] hover:bg-[#E2E8F0] text-[#0C1421] font-bold rounded font-royal text-xs flex items-center gap-1.5 shadow"
                >
